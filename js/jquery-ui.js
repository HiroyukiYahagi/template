        ...
        fit: {
            left: function(position, data) {
                ...
                if (data.collisionWidth > outerWidth) {
                    ...
                    } else // element is initially over right side of within
                    if (overRight > 0 && overLeft <= 0) {
                        position.left = withinOffset;

                    } else // element is initially over both left and right sides of within
                    {
                ...
                } else // too far left -> align with left edge
                if (overLeft > 0) {
                    position.left += overLeft;

                } else // too far right -> align with right edge
                if (overRight > 0) {
                    position.left -= overRight;

                } else // adjust based on position and margin
                {
            ...
            top: function(position, data) {
                ...
                if (data.collisionHeight > outerHeight) {
                    ...
                    } else // element is initially over bottom of within
                    if (overBottom > 0 && overTop <= 0) {
                        position.top = withinOffset;

                    } else // element is initially over both top and bottom of within
                    {
                ...
                } else // too far up -> align with top
                if (overTop > 0) {
                    position.top += overTop;

                } else // too far down -> align with bottom edge
                if (overBottom > 0) {
    ...
    $.widget("ui.slider", $.ui.mouse, {
        ...
        _create: function() {
            ...
            if (o.range) {
                ...
                this.range = $("<div></div>")
                .appendTo(this.element)
                .addClass("ui-slider-range" + // note: this isn't the most fittingly semantic framework class for this element,
...
(function($, undefined) {
    ...
    $.widget("ui.tabs", {
        ...
        refresh: function() {
            ...
            } else // was active, but active tab is gone
            if (this.active.length && !$.contains(this.tablist[0], this.active[0])) {
                ...
                } else // activate previous tab
                {
                    this._activate(this._findNextTab(Math.max(0, options.active - 1), false));
                }

            } else // was active, active tab still exists
            {
